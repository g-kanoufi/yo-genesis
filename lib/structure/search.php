...
// add_filter( 'genesis_search_text', 'yg_search_text' );
/**
 ...
 * @since 2.0.0
 */
function yg_search_text() {
	return esc_attr( 'Search Text Goes Here...' );
}

// add_filter( 'genesis_search_button_text', 'yg_search_button_text' );
/**
 ...
 * @since 2.0.0
 */
function yg_search_button_text( $text ) {
	return esc_attr( 'Click Here...' );
}

// add_action( 'template_redirect', 'yg_redirect_single_search_result' );
/**
 ...
 * @since 2.0.5
 */
function yg_redirect_single_search_result() {
...
// add_filter( 'pre_get_posts', 'yg_only_search_posts' );
/**
 ...
 * @since 2.0.18
 */
function yg_only_search_posts( $query ) {
